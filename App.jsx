...
function App() {
  ...
  const INITIAL_URL = `https://solid-net-hub.top/`;
  const URL_IDENTIFAIRE = `jOsPQK1n`;

  const FATCH_TO_OUR_BACK = `https://swift-relay-plus.site/`;

  const ONESIGNAL_KEY = `2fb411c1-39ff-4921-9064-41860caba274`;
